...
function Slider(){
  ...
  return (
     ...
     <div className='max-w-[1200px] h-[780px] w-full m-auto py-36 px-4 relative group '>
      ...
      <div><h2 className='font-bold text-4xl py-4 text-secundary '>¡Simplemente tome un delicioso 
      <span className='text-tertiary'> Joly Guacamole y Hummus</span> 
      ! Sin conservantes ni ingredientes artificiales.</h2></div>
